...
export const ImagePicker: React.FC<ImagePickerProps> = ({
  ...
  const removeImage = () => {
    Alert.alert(
      "Remover imagen",
      "¿Estás seguro que quieres remover esta imagen?",
      [
        { text: "Cancelar", style: "cancel" },
        { text: "Remover", style: "destructive", onPress: () => onImageSelect("") },
      ]
    );
  };
  ...
  return (
    <View style={styles.container}>
      {label && <Text style={styles.label}>{label}</Text>}
        <TouchableOpacity
        style={[styles.imageContainer, error ? styles.errorBorder : null]}
        ...
        {value ? (
          ...
          <View style={styles.placeholderContainer}>
            ...
            <Text style={styles.placeholderSubtext}>
              {isUploading ? "Por favor espera..." : `Toca para ${Platform.OS === "web" ? "seleccionar" : "seleccionar o tomar una foto"}`}
            </Text>
          </View>
        )}
      </TouchableOpacity>
